...
export interface OrderSizeType {
 ...
 */
export type StopLossFn<BarT extends IBar, ParametersT = any> = (args: IStopLossArgs<BarT, ParametersT>) => Decimal;
 ...
 */
export type ProfitTargetFn<BarT extends IBar, ParametersT = any> = (args: IProfitTargetArgs<BarT, ParametersT>) => Decimal;
